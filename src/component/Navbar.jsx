                ...
                <div className={`items-center justify-between ${!isOpenNav ? 'hidden' : ''} w-full md:flex md:w-auto md:order-1`} id="navbar-search">
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium text-lg first-line:border rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-gray-800 md:bg-gray-900 border-gray-700">
                        <li>
                            <NavLink to={'/'}
                                className={({ isActive }) =>
                                    isActive ? 'block py-2 px-3 text-white md:bg-transparent bg-blue-700 rounded md:p-0 md:text-blue-500'
                        ...
                        <li>
                            <NavLink to="https://hafdev-portofolio.vercel.app/" target="_blank"
                                className={({ isActive }) =>
                                    isActive ? 'block py-2 px-3 text-white md:bg-transparent bg-blue-700 rounded md:p-0 md:text-blue-500'
                                        : 'block py-2 px-3 rounded md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 text-white dark:hover:bg-gray-700 hover:text-white md:hover:bg-transparent'
                                }>
                                About
                            </NavLink>
                        </li>
